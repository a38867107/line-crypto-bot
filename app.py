...
# ==================== 金鑰設定 ====================
# 為了安全與方便管理，我們讓程式直接讀取雲端平台的環境變數
LINE_CHANNEL_ACCESS_TOKEN = os.environ.get("LINE_CHANNEL_ACCESS_TOKEN", "你的_ACCESS_TOKEN")
LINE_CHANNEL_SECRET = os.environ.get("LINE_CHANNEL_SECRET", "你的_SECRET")
# ==================================================
...
if __name__ == "__main__":
    # 雲端平台會動態分配 Port，所以要讀取環境變數中的 PORT
